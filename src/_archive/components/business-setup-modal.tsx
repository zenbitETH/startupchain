...
export function BusinessSetupModal({
  ...
  const [registerToDifferentAddress, setRegisterToDifferentAddress] =
    useState(false)
  ...
  const handleFounderModeChange = (isMultiple: boolean) => {
    ...
    if (!isMultiple) {
      ...
      setFounders([
        { id: '1', address: userAddress, equity: '50' },
  ...
  const totalEquity = founders.reduce(
    (sum, founder) => sum + (parseFloat(founder.equity) || 0),
    0
  )
  ...
  const handleCreateBusiness = async () => {
    ...
    // Validate custom address if using different registration address
    if (registerToDifferentAddress && !customAddress.trim()) {
      // Handle validation error - you might want to show an error state
      return
    }
  ...
  const handleProceedWithRegistration = async () => {
    ...
    try {
      ...
      // Pass custom address if registering to different address
          ...
          <div className="relative mx-4 w-full max-w-2xl">
            <div className="bg-card border-border relative overflow-hidden rounded-2xl border shadow-2xl">
              ...
              <div className="max-h-[80vh] overflow-y-auto p-6">
                ...
                {/* Register to Different Address Option */}
                {!isMultipleFounders && (
                  <div className="mb-6">
                    <div className="flex items-center gap-3">
                      <input
                        ...
                        onChange={(e) =>
                          setRegisterToDifferentAddress(e.target.checked)
                        }
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1 text-lg">
                            <input
                              type="text"
                              placeholder={
                                founder.id === '1' && !isMultipleFounders
                                  ? 'Your email/address (auto-filled)'
                                  : 'Email or ETH address'
                              }
                ...
                <div className="bg-muted/10 border-border mb-8 rounded-xl border p-4">
                  ...
                  <ul className="text-muted-foreground space-y-1 text-sm">
                    ...
                    <li>
                      • A Smart Wallet (Safe) will be created for your business
                    </li>
                    <li>
                      • Your ENS name will be registered to{' '}
                      {registerToDifferentAddress
                    ...
                    <li>
                      • All transactions will be gasless (we pay the fees)
                    </li>
